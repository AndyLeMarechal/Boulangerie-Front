<template>
    <div class="hero-body">
                    ...
                    <div class="columns is-vcentered">
                        <div class="column is-5">
                            <figure class="image is-4by3">
                                <img class="" :src=" saltySide.img " :alt=" saltySide.title">
                            </figure>
                        </div>
                ...
                <div class="container section ">
                    ...
                    <p id="1" :class="{ 'is-hidden' : liActive != '1' }">{{ saltySide.method_of_conservation }}</p>
                    <p id="2" :class="{ 'is-hidden' : liActive != '2' }">{{ saltySide.composition }}</p>
                    <p id="3" :class="{ 'is-hidden' : liActive != '3' }">{{ saltySide.nutritional_values }}</p>
                    <p id="4" :class="{ 'is-hidden' : liActive != '4' }">{{ saltySide.allergens }}</p>
                    </div>
                </div>
